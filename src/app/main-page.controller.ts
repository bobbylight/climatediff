...
import { IHttpResponse, IHttpService, ILogService, IScope, ITimeoutService } from 'angular';
...
export default class MainPageController {
    ...
    constructor($scope: IScope, private $http: IHttpService, private $timeout: ITimeoutService,
                private $log: ILogService, private Utils: UtilService) {
